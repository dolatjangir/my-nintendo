   ...
   <!-- page-3-part-3 -->
    <div class="sm:mt-2 xl:mt-4 sm:px-4 xl:px-0 pb-4">
      <ul class="flex xl:w-[374px] 2xl:w-[528px] 3xl:w-[658px]">
        ...
        <li class="mx-1"><img loading="lazy" class="sm:w-[58px] 3xl:w-[88px] 3xl:h-[50px] sm:h-8 rounded-xl" src="https://assets.nintendo.com/image/upload/ar_16:9,b_auto:border,c_lpad/b_white/f_auto/q_auto/dpr_1.5/c_scale,w_100/ncom/software/switch/70010000001801/9c33645aee20fb323e579cd75036df000f2322de1be04662c989d42047ffbfdb" /></li>
        <li class="ml-1"><img loading="lazy" class="sm:w-[58px] 3xl:w-[88px] 3xl:h-[50px] sm:h-8 rounded-xl" src="https://assets.nintendo.com/image/upload/ar_16:9,b_auto:border,c_lpad/b_white/f_auto/q_auto/dpr_1.5/c_scale,w_100/ncom/software/switch/70010000001801/a14b2ba7d7d59e9ab25a74871d4d41f83527cba7485cd024bbc518c1433932c0" /></li>
      </ul>
    </div>
    <!-- this page seen only on xl size -->
    <div class="sm:hidden xl:flex">
    <div class="w-[44.2px]  h-[66px] border border-black"></div>  
    <div class="text-xs pl-4 w-[317px] 2xl:w-[352px]">
      <p class="pb-2">Fantasy Violence, Use of Alcohol, Use of Tobacco, Simulated Gambling, Mild Language, Mild Blood</p>
      <hr />
      <p class="pt-1">Users Interact  </p>
    </div>
    </div>
  </div>
    <!-- page-3-part-4 -->
     <div class=" xl:ml-12 xl:pt-9">
      <ul class="flex flex-col sm:justify-around xl:justify-between sm:px-4 sm:pb-5 xl:px-0 xl:pb-0 sm:h-[345px] xl:h-[370px]">
        <li class="border-l-2 border-red-600 text-xs pl-1 pb-1">Nintendo Switch</li>
        <li class="text-xl 3xl:text-3xl 3xl:font-bold tracking-wider text-neutral-600 ">Stradew Valley</li>
        <li class="text-xl xl:text-2xl xl:font-medium font-extrabold tracking-wider text-neutral-700 flex flex-row justify-between  2xl:text-3xl 2xl:text-neutral-500 2xl:font-bold">$14.99 <span class="text-red-600 font-extrabold"><i class="fa-regular fa-heart"></i></span></li>
        <li class=" xl:mb-6 2xl:mb-0 text-xs font-extrabold items-center space-x-3 tracking-wider text-neutral-700 flex flex-row"><img class="w-6 h-6" src="https://assets.nintendo.com/image/upload/f_auto/q_auto/dpr_1.5/c_scale,w_100/Design%20System/Component%20Library/Icon/my-nintendo-gold-coin.png ">
        <p class="">Eligible for up to  Gold Points</p></li>
        <li class="sm:w-[288px] md:w-[343px] lg:w-[393px] xl:w-[249px] 2xl:w-[352px] 3xl:w-[438.3px] bg-[#CC0000] text-white text-xl font-semibold flex justify-center rounded-xl sm:h-14 xl:h-16"><button><i class="fa-solid fa-download"></i><span class="pl-3">Direct download</span></button></li>
        <li class="text-xs tracking-tighter font-bold">This item will be sent to your system automatically after purchase.</li>
      </ul>
     </div>
</div>
</div>
<!-- page-4 -->
 <div class="xl:mt-16 xl:pt-12 sm:mt-8 sm:pt-8 mx-4 flex flex-col items-center xl:flex-row xl:items-start 3xl:justify-center">
  <ul class="xl:w-[354px] 2xl:w-[477.5px] 3xl:w-[558px]">
    <li>You're moving to the valley...</li>
    <li class="mt-[14px] xl:text-sm 2xl:text-lg xl:font-semibold">You’ve inherited your grandfather’s old farm plot in Stardew Valley. Armed with hand-me-down tools and a few coins, you set out to begin your new life. Can you learn to live off the land and turn these overgrown fields into a thriving home? It won’t be easy. Ever since Joja Corporation came to town, the old ways of life have all but disappeared. The community center, once the town’s most vibrant hub of activity, now lies in shambles. But the valley seems full of opportunity. With a little dedication, you might just be the one to restore Stardew Valley to greatness!</li>
    <li><button class="text-[#CC0000] font-bold text-xl py-2 pr-2"><span class="text-3xl font-bold">+</span> Read More</button></li>
    <li>Software description provided by the publisher.</li>
    <li class="mt-4"><button class="md:w-[343px] sm:w-[309px] h-[48px] lg:w-[393px] xl:w-[342.4px] text-lg bg-[#CC0000] text-white rounded-xl">Explore this game's official website</button></li>
  </ul>
   <div class="">
      <img class="sm:w-[343px] sm:h-[193px] lg:w-screen  xl:w-[354.3px] xl:h-[199.8px] 2xl:w-[477.5px] 2xl:h-[268.6px] 3xl:w-[558px] 3xl:h-[313.5px] xl:ml-6 sm:mt-8 xl:mt-0  rounded-xl" src="https://assets.nintendo.com/image/upload/ar_16:9,c_lpad,w_656/b_white/f_auto/q_auto/ncom/software/switch/70010000001801/7aa9c6cf5e7d4cecf481f18b1d7a9d79e7aab85045b22203effb2dda409bc5b7"/>
    </div>
 </div>
 <!-- page-5 -->
  <div class="py-8 2xl:py-16  xl:flex xl:items-center 2xl:justify-center">
  <div class=" md:mx-4">
    <div class="px-8 py-6 bg-neutral-200 xl:h-[229px] 2xl:w-[479.5px] 3xl:w-[560px] rounded-xl">
      <div>
        <h1  class=" text-center mb-4">ESRB rating</h1>
        <div>
          <div class="flex px-8 py-4 mb-8  rounded-xl bg-white md:w-[288px] 2xl:w-[415.1px] 3xl:w-[473px] md:h-[109px]">
         <div class=" border border-black sm:w-[44px] md:w-[50px] sm:h-[75px]"></div>  
            <div class="text-xs pl-4">
      <p class="pb-2 sm:w-[132px] md:w-[160.6px] 2xl:w-[294.1px] 3xl:w-[352px] h-[36px] text-xs tracking-tighter">Fantasy Violence, Use of Tobacco, Simulated Gambling, Mild Language, Mild Blood</p>
      <hr />
      <p class="pt-1">Users Interact  </p>
    </div>
    </div>
  ...
  <!-- part-2 -->
    <div class="sm:pt-8 xl:pt-0 ">
       <div class="md:mx-4">
    <div class="px-8 py-6 bg-neutral-200 xl:w-[356px] xl:h-[229px] 2xl:w-[479.5px] 3xl:w-[560px] rounded-xl">
      <div>
        <h1  class=" text-center mb-4">supported play modes</h1>
      </div>
      <div class="flex justify-between">
        <ul class=" w-[80px] 3xl:w-[149.4px]">
          <li class="bg-[#484848] px-4 py-4 3xl:flex 3xl:justify-center text-white rounded-xl"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="48" role="presentation" alt="" data-testid="TvModeIcon" size="48" color="currentColor"><g fill="currentColor"><path d="M11.903 16.114l-1.154-3.56H9.591l1.641 4.627h1.357l1.632-4.627h-1.163zm-7.604-2.58h1.36v3.646h1.058v-3.646h1.371v-.981H4.299zm17.743 9.126v.758H32v-6.702h-9.958z"></path><path d="M8.433 21.6H4.784v1.808h3.649v.01h1.656v-.01h3.645V21.6H10.09v-.737h8.443V8.582H0v12.281h8.433v.737zM2.11 18.956v-8.453h14.31v8.453H2.11z"></path><path d="M16.333 21.6h-.603v1.801h5.589v-.602h-4.986z"></path></g></svg></li>
          <li class="my-[14px] text-center">TV</li>
        </ul>
        <ul class=" w-[80px] 3xl:w-[149.4px]">
          <li class="bg-[#484848] px-4 py-4 3xl:flex 3xl:justify-center text-white rounded-xl"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="48" role="presentation" alt="" data-testid="TabletopModeIcon" size="48" color="currentColor"><path d="M31.32 18.242l-2.657-6.94-1.285 6.94h3.943zM28.174 5.336H6.418l-2.74 12.906h21.754l2.741-12.906zm-5.035 10.505H6.99l1.722-8.094h16.143l-1.717 8.094zm-21.741 5.03H0v.995h.02a.098.098 0 0 0-.02.059v2.008a2.734 2.734 0 0 0 2.736 2.731h7.426a2.737 2.737 0 0 0 2.741-2.731v-2.008a.18.18 0 0 0-.01-.06h.01v-.994H1.397zm7.64.31a1 1 0 1 1-1.004 1.002c0-.554.45-1.002 1.004-1.001zm-5.845 4.43a1.837 1.837 0 1 1 1.858-1.833c-.003.49-.2.958-.55 1.302a1.839 1.839 0 0 1-1.308.53zm3.24-1.833a1.009 1.009 0 0 1 1.004-.985.981.981 0 1 1-1.004.985zm2.605 2.57a.983.983 0 1 1 .99-.978.988.988 0 0 1-.99.977zm1.591-1.591a.982.982 0 1 1 0-1.964.982.982 0 1 1 0 1.964zM32 20.87H19.097v.995h.02a.098.098 0 0 0-.02.059v2.008a2.73 2.73 0 0 0 2.731 2.731h7.431A2.738 2.738 0 0 0 32 23.933v-2.009a.18.18 0 0 0-.01-.06H32v-.994zm-3.866.31a1 1 0 0 1-.006 1.999.999.999 0 1 1 .006-1.998zm-5.85 4.43a1.836 1.836 0 0 1 0-3.673 1.837 1.837 0 1 1 0 3.672zm3.24-1.833c.015-.545.459-.98 1.004-.985a.981.981 0 1 1 0 1.964c-.544 0-.99-.434-1.004-.979zm2.61 2.57a.983.983 0 1 1 .99-.978.988.988 0 0 1-.99.977zm1.586-1.591a.982.982 0 1 1 0-1.964.982.982 0 1 1 0 1.964z" fill="currentColor" fill-rule="evenodd"></path></svg></li>
          <li class="my-[14px] text-center">Tabletop</li>
        </ul>
        <ul class=" w-[80px] 3xl:w-[149.4px]">
          <li class="bg-[#484848] 3xl:flex 3xl:justify-center px-4 py-4 text-white rounded-xl"><svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" width="48" role="presentation" alt="" data-testid="HandheldModeIcon" size="48" color="currentColor"><path d="M28.812 8.455h-2.353c-.014 0-.038.009-.052.009v-.01H5.621v.014c-.028-.004-.061-.013-.07-.013H3.192A3.196 3.196 0 0 0 0 11.65v8.696a3.203 3.203 0 0 0 3.193 3.198H5.55c.01 0 .043-.01.07-.015v.015h20.787v-.015a.163.163 0 0 0 .052.015h2.353A3.195 3.195 0 0 0 32 20.346V11.65a3.187 3.187 0 0 0-3.188-3.196zm-.183 1.973a1.014 1.014 0 1 1-1.012 1.012 1.006 1.006 0 0 1 1.012-1.012zm.994 4.276a1.003 1.003 0 1 1-2.005-.021 1.003 1.003 0 0 1 2.005.021zM3.521 10.428a1.89 1.89 0 1 1-.703 3.639 1.892 1.892 0 0 1-1.168-1.755c0-1.035.835-1.877 1.87-1.884zm1.007 6.22a1.001 1.001 0 0 1-1.509.882 1.007 1.007 0 0 1-.497-.882 1.024 1.024 0 0 1 .999-1.026 1.03 1.03 0 0 1 1.007 1.026zM.896 18.29a1.003 1.003 0 1 1 2.006.018 1.003 1.003 0 0 1-2.006-.018zm2.625 2.636a1.012 1.012 0 0 1-.725-1.727 1.013 1.013 0 0 1 1.732.713 1.008 1.008 0 0 1-1.007 1.014zm1.636-1.623a1.02 1.02 0 1 1-.004-2.04 1.02 1.02 0 0 1 .004 2.04zm20.092 1.42H6.774v-9.45H25.25v9.45zm.722-7.66a1.021 1.021 0 1 1 2.043.009 1.021 1.021 0 0 1-2.043-.009zm2.658 7.863a1.892 1.892 0 1 1 1.866-1.88 1.88 1.88 0 0 1-1.866 1.88zm1.622-6.836a1.019 1.019 0 0 1-.748-1.726 1.018 1.018 0 1 1 .748 1.726z" fill="currentColor"></path></svg></li>
          <li class="my-[14px] text-center">Handhold</li>
        </ul>
      </div>
    </div>
  ...
  <!-- page-6 -->
   <div class="px-4 3xl:mx-32 pb-12">
    <!-- 1 -->
    <div class="flex sm:justify-between xl:justify-start 3xl:justify-center px-2 py-4 border-b border-t border-neutral-400 ">
      ...
      <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px] xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px] font-bold">Release date</h2>
        <p class="xl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 2xl:text-lg 3xl:w-[706.6px]">October 8,2017</p>
      </div>
    </div>
    <!-- 2 -->
     <div class="flex sm:justify-between xl:justify-start 3xl:justify-center items-start px-2 py-4 border-b  border-neutral-400 ">
      ...
      <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px] xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px]  font-bold">No. of Players</h2>
        <p class="text-[#E60012] underline text-lg font-semiboldxl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 3xl:w-[706.6px]">Single system(1)<br/>Local wireless(1)<br/>Online(1-4)</p>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="28" role="presentation" alt="" data-testid="DPadIcon" size="28" color="currentColor"><path d="M30.1 10.4h-8.5V1.9c0-1-.8-1.9-1.9-1.9h-7.5c-1 0-1.9.8-1.9 1.9v8.5H1.9c-1 0-1.9.8-1.9 1.9v7.5c0 1 .8 1.9 1.9 1.9h8.5v8.5c0 1 .8 1.9 1.9 1.9h7.5c1 0 1.9-.8 1.9-1.9v-8.5h8.5c1 0 1.9-.8 1.9-1.9v-7.5c-.1-1.1-.9-1.9-2-1.9zM7.5 16.9H3.8c-.5 0-.9-.4-.9-.9s.4-.9.9-.9h3.8c.5 0 .9.4.9.9s-.5.9-1 .9zm9.4 11.3c0 .5-.4.9-.9.9s-.9-.4-.9-.9v-3.8c0-.5.4-.9.9-.9s.9.4.9.9v3.8zm0-20.7c0 .5-.4.9-.9.9s-.9-.4-.9-.9V3.8c0-.5.4-.9.9-.9s.9.4.9.9v3.7zm11.3 9.4h-3.8c-.5 0-.9-.4-.9-.9s.4-.9.9-.9h3.8c.5 0 .9.4.9.9.1.5-.3.9-.9.9z" fill-rule="evenodd" clip-rule="evenodd" fill="currentColor"></path></svg>   
   <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px]  xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px]  font-bold">Genre</h2>
        <p class="text-[#E60012] underline text-lg font-semibold xl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 3xl:w-[706.6px]">Role-playing Simulation</p>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="28" role="presentation" alt="" data-testid="BuildingIcon" size="28" color="currentColor"><path d="M28.9 2.1C28.9 1 28 0 26.8 0H5.6C4.4 0 3.5 1 3.5 2.1v29.8H12v-6.4h7.4v6.4h9.5V2.1zm-19 25.6H6.7v-3.2h3.2v3.2zm0-5.4H6.7v-3.2h3.2v3.2zm0-5.3H6.7v-3.2h3.2V17zm0-5.3H6.7V8.5h3.2v3.2zm0-5.3H6.7V3.2h3.2v3.2zm5.2 15.9H12v-3.2h3.2v3.2zm0-5.3H12v-3.2h3.2V17zm0-5.3H12V8.5h3.2v3.2zm0-5.3H12V3.2h3.2v3.2zm5.3 15.9h-3.2v-3.2h3.2v3.2zm0-5.3h-3.2v-3.2h3.2V17zm0-5.3h-3.2V8.5h3.2v3.2zm0-5.3h-3.2V3.2h3.2v3.2zm5.3 21.3h-3.2v-3.2h3.2v3.2zm0-5.4h-3.2v-3.2h3.2v3.2zm0-5.3h-3.2v-3.2h3.2V17zm0-5.3h-3.2V8.5h3.2v3.2zm0-5.3h-3.2V3.2h3.2v3.2z" fill-rule="evenodd" clip-rule="evenodd" fill="currentColor"></path></svg>
        <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px]  xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px]  font-bold">Publisher</h2>
        <p class="text-[#E60012] underline text-lg font-semibold xl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 3xl:w-[706.6px]">ConcernedApe</p>
    ...
    <div class="flex sm:justify-between xl:justify-start 3xl:justify-center items-start px-2 py-4 border-b  border-neutral-400 ">
      ...
      <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px]  xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px] font-bold">Developer</h2>
        <p class="text-[#E60012] underline text-lg font-semibold xl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 3xl:w-[706.6px]">ConcernedApe</p>
    ...
    <div class="flex sm:justify-between xl:justify-start 3xl:justify-center items-start px-2 py-4 border-b  border-neutral-400 ">
      ...
      <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px]  xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px] font-bold">ESRB rating</h2>
        <p class="text-[#E60012] underline text-lg font-semibold xl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 3xl:w-[706.6px]">Everyone 10+</p>
    ...
    <div class="flex sm:justify-between xl:justify-start 3xl:justify-center items-start px-2 py-4 border-b  border-neutral-400 ">
      ...
      <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px]   xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px] font-bold">Supported play modes</h2>
        <p class="w-[224px] md:w-[279px] lg:w-[329px] text-xs 2xl:text-lg font-semibold xl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 3xl:w-[706.6px]">TV mode, Tabletop mode, Handheld mode</p>
     ...
     <div class="flex sm:justify-between xl:justify-start 3xl:justify-center items-start px-2 py-4 border-b  border-neutral-400 ">
      ...
      <div class="xl:flex">
        <h2 class="w-[224px] md:w-[279px] lg:w-[329px]  xl:w-[217px] xl:pl-7 2xl:w-[299.6px] 3xl:w-[353.3px] font-bold">Game file size</h2>
        <p class="w-[224px] md:w-[279px] lg:w-[329px] text-sm 2xl:text-lg font-semibold  xl:w-[425.2px] xl:pl-7 2xl:w-[599.3px] 3xl:w-[706.6px]">1.6 GB</p>
